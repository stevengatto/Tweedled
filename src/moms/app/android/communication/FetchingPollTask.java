    ...
    private void createListView()
    {
        try {
            ...
            for(int i = poll_count - 1; i >= 0 ;i--)
            {
                ...
                String description = (poll_json.getString("description").equals("null")) ?
                        "No description" : poll_json.getString("description");
//                Log.d(null, "Description " + id + " found to be: " + description + "\n");
